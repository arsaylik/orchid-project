                ...
                <div class="md:w-2/3 w-full px-4 mt-20 text-white flex flex-col">
                    ...
                    <div class="flex mt-8 flex-col md:flex-row md:justify-between">
                        <p class="w-full md:w-2/3 text-gray-400">
                            You can contact me for the issues you want to get
                            information about.
                        </p>
                    ...
                    <div class="flex flex-col">
                        <div class="flex mt-24 mb-12 flex-row justify-between">
                            ...
                            <div class="flex flex-row space-x-8 items-center justify-between">
                                <a
                                    class="glassIco"
                                    href="https://www.instagram.com/rasitt.official/"
                                >
                                    <i class="fab fa-instagram"></i>
                                </a>
                                <a
                                    class="glassIco"
                                    href="https://www.linkedin.com/in/ahmet-ra%C5%9Fit-saylik-1aab821b6/"
                                >
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                                <a
                                    class="glassIco"
                                    href="https://github.com/arsaylik"
                                >
                        ...
                        <p class="w-full text-center mt-10 text-gray-600">
                            Copyright © 2023 𝓐𝓡𝓢{" "}
                        </p>
                    </div>
                </div>
